...
"""
    ...
    def highlight_region(self, event):
        ...
        # Use binary closing to dilate then erode image: Done to close dotted lines
        closed_binary = binary_closing(mag)

        # Skeletonize is used to make the sectioning lines as small as possible
