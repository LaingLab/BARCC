import numpy as np
from skimage import io, filters, morphology, measure, util, feature, segmentation
...
def count_fos_positive(input_path, output_path):
    ...
    Generates a new image with cell IDs marked on each detected cell.
    ...
    """
    # Load image (assume grayscale; convert if not)
    ...
    # Generate annotated image (load original, which may be grayscale; convert to RGB for annotation)
